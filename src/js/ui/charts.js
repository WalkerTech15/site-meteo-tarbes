/* Interactive SVG line/bar charts.
   Smooth monotone curve · 10% area wash · crosshair + tooltip.
   Self-contained: takes a host element and a plain options object, reads
   only CSS custom properties for theming — no app state dependency. */
