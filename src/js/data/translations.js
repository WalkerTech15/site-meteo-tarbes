...
export const I18N = {
  en: {
    ...
    aboutText2:
      "Weather data is provided by the Open-Meteo public API. When offline, a realistic demo dataset keeps the experience fully explorable.",
    ...
    notifSub: "Receive important alerts and updates.",
    notif1T: "Severe weather alerts",
    notif1X: "Be warned of dangerous conditions.",
    notif2T: "Daily forecast",
    notif2X: "Get your weather bulletin every morning.",
    notif3T: "Condition changes",
    notif3X: "Notifications when conditions change significantly.",
    notif4T: "New features",
    notif4X: "Hear about what's new in the app.",
  ...
  fr: {
    ...
    aboutText2:
      "Les données météo proviennent de l'API publique Open-Meteo. Hors ligne, un jeu de données de démonstration réaliste garde l'application pleinement explorable.",
    ...
    themeSystem: "Système",
    notifTitle: "Notifications",
    notifSub: "Recevez des alertes et des mises à jour importantes.",
    notif1T: "Alertes météo sévères",
    notif1X: "Soyez averti des conditions dangereuses.",
    notif2T: "Prévisions quotidiennes",
    notif2X: "Recevez votre bulletin météo chaque matin.",
    notif3T: "Changements de conditions",
    notif3X: "Notifications en cas de changements importants.",
    notif4T: "Nouvelles fonctionnalités",
    notif4X: "Être informé des nouveautés de l'application.",
