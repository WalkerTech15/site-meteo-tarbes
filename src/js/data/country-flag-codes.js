/* Generated from flag-icons 7.5.0 (MIT), whose SVGs are vendored under
   public/assets/flags/countries/. Keep this manifest in sync with that folder
   so unknown geocoder codes still receive the existing text fallback instead
   of producing a broken image request. */
export const COUNTRY_FLAG_CODES = new Set(
